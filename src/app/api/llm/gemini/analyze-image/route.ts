...
const MODEL_NAME = "gemini-2.0-flash-latest"; // Corrected model name as per previous context, ensure this is what you intend. Gemini 2.0 flash might be "gemini-2.0-flash-latest"
